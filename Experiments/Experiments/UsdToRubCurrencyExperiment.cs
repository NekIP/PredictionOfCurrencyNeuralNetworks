...
namespace Experiment {
    public class UsdToRubCurrencyExperiment : Experiment {
        public override async void Run() {
            ...
            var res1 = await collector.List(DateTime.Now - TimeSpan.FromHours(96), DateTime.Now, TimeSpan.FromHours(1));
            var res2 = await collector.List(DateTime.Now - TimeSpan.FromHours(96), DateTime.Now, TimeSpan.FromHours(2));
            var res24 = await collector.List(DateTime.Now - TimeSpan.FromHours(96), DateTime.Now, TimeSpan.FromHours(24));
